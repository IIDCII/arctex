...
#include "src/synchronous_functions/synchronous_functions.cuh"
...
void test_basic_functions() {
  ...
  CU_add_test(suite, "Equality of same value matrices",
              test_equality_same_values);
  CU_add_test(suite, "Equality of different value matrices",
              test_equality_different_value);
  CU_add_test(suite, "Equality of matrix with itself",
              test_equality_reflexively);
  ...
  CU_add_test(suite, "Addition of differently filled matrices",
              test_addition_ones_and_twos);
  CU_add_test(suite, "Addition of manually filled matrices",
              test_addition_manual_values);
  ...
  CU_add_test(suite, "Addition of non square matrices",
              test_addition_non_square_matrices);
  CU_add_test(suite,
              "Addition of matrices with differing row sizes throws error",
              test_addition_differing_rows_error);
  CU_add_test(suite,
              "Addition of matrices with differing columns sizes throws error",
