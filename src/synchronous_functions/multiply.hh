...
template <typename T>
[[nodiscard]] Matrix<T> *synchronousMultiplication(Matrix<T> *matrix1, Matrix<T> *matrix2);

template <typename T>
void multiplyIntoResult(Matrix<T> *matrix1, Matrix<T> *matrix2, Matrix<T> *result) {
...
[[nodiscard]] Matrix<T> *synchronousMultiplication(Matrix<T> *matrix1, Matrix<T> *matrix2) {
  ...
  multiplyIntoResult(matrix1, matrix2, result);
  return result;
}
